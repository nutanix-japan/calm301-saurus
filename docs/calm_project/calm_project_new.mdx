...
2. Fill in the Project Name. Eg Trainee_Project_Name. Click on **Create**
...
## Add Infrastructure to the Project
...
3. Click on **Select Cluster** and click on **Select VLANs**

   ![](images/select-cluster-pc2022-6.png)

4. Check on **Primary** Network and click on **Select VPCs and Subnets**

   ![](images/select-vlan-pc2022-6.png)

5. The project is now in **Active** state

   ![](images/project-active.png)

### Configure VPC to the project 

This section is for cluster configured with VPC.  

1. Select **VPCs & Subnets**

   ![](images/project-vpc-2022-6.png)

2. Select **VPC**. Select the Overlay Subnet **SG-AMK** Network. Click on **Confirm**.

   ![](images/project-vpc-2022-6.png)

3. Review and click on **Confirm**
...
2. Check on the **Quotas** check-box
...
2. Fill in the name for the environment. Eg **Default Environment**

   ![](images/default-environment.png)

3. Click on **Select Infrastructure**
...
7. Click on **Linux**. Fill in the following hardware specification

   ![](images/linux-hw-pc2022-6.png)

8. Copy the **cloud-init** contents into the **Guest Customization**
   ...
   ```
9. Expand the **DISK** section. Select the disk image as shown
   
   ![](images/env-disk-image-pc2022-6.png)

10. Expand the **Network Adapter** section

11. Select the Network Adapter: **Primary**

    ![](images/env-network-adapter-pc2022-6.png)

12. Expand the **Connection** section. Click on **Add New Credential**
